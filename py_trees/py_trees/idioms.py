...
def pick_up_where_you_left_off(
    ...
    .. note::
       ...
       spins up the tasks required each time the task_base sequence is first
       ...
       visible the task_base sequence itself at all times (i.e. burying
    ...
    Args:
        name (:obj:`str`): the name to use for the task_base sequence behaviour
